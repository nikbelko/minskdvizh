import { Film, Music, Drama, Frame, Baby, Trophy, Sparkles, Gift, Map, ShoppingBag, Palette, Dices, Tv, BookOpen, HelpCircle, Pin, PartyPopper, Key } from 'lucide-react';
...
const iconConfig: Record<CategorySlug, { icon: React.ElementType; color: string; border: string; glow: string }> = {
  ...
  fest:        { icon: PartyPopper, color: 'text-yellow-400',  border: 'border-yellow-400/25',  glow: 'shadow-yellow-500/10' },
  ...
  quests:      { icon: Key,         color: 'text-lime-400',    border: 'border-lime-400/25',    glow: 'shadow-lime-500/10' },
